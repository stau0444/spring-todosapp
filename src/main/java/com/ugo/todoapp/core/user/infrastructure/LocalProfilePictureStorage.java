package com.ugo.todoapp.core.user.infrastructure;
...
import com.ugo.todoapp.core.user.domain.FailedLoadingProfilePictureException;
import com.ugo.todoapp.core.user.domain.FailedSavingProfilePictureException;
...
public class LocalProfilePictureStorage implements ProfilePictureStorage, ResourceLoaderAware, InitializingBean {
    ...
    private final Logger log = LoggerFactory.getLogger(LocalProfilePictureStorage.class);
